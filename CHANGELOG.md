...
### Fixed
- Keep CONNECT discovery responsive on full port ranges by bounding adaptive connection timeouts while retaining a controlled default worker count; service probe timeouts remain adaptive.
